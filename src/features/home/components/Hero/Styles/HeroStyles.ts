export const HERO_STYLES = {
    section: "relative pt-32 pb-20 md:pt-48 md:pb-32 flex items-center min-h-screen bg-black overflow-hidden",
    ...
    badge: "inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-red-600/20 border-2 border-red-500/40 text-red-400 text-[11px] font-black uppercase tracking-widest shadow-[0_0_15px_rgba(239,68,68,0.3)]",
    badge_dot: "flex h-3 w-3 rounded-full bg-red-500 animate-pulse shadow-[0_0_10px_rgba(239,68,68,1)]",
